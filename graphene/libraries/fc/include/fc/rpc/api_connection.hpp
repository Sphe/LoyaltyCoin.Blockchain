...
namespace fc {
   ...
   class api_connection : public std::enable_shared_from_this<fc::api_connection>
   {
      public:
         ...
         api_id_type register_api( const Interface& a )
         {
			...
			auto arg1 = static_cast<const Interface&>(a);
			auto arg2 = static_cast<const std::shared_ptr<fc::api_connection>&>(shared_from_this());

            _local_apis.push_back( std::unique_ptr<fc::generic_api>(new fc::generic_api(arg1, arg2)));
      ...
      private:
         std::vector< std::unique_ptr<fc::generic_api> >             _local_apis;
   ...
   :_api_connection(c),_api(a)
   {
      ...
      boost::any_cast<const Api&>(a)->visit( api_visitor( *this, c ) );
	   ...
	   //auto arg1 = fc::generic_api::api_visitor(*this, c);

	   //const Api& b = boost::any_cast<const Api&>(a);
	   ...
	   //api_visitor(static_cast<generic_api&>(*this), c)
   }
   ...
   std::function<variant(const fc::variants&)> generic_api::api_visitor::to_generic( const std::function<R(Args...)>& f )const
   {
      ...
      return [f,gapi]( const variants& args ) -> fc::variant {
